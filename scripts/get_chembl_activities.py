...
if __name__ == "__main__":
    ...
    # Path for complete metadata from https://github.com/gwatkinson/jump_download
    METADATA_PATH = "/projects/cpjump1/jump/metadata/complete_metadata.csv"
    # Need to dwnload Chembl database
    CHEMBL_DB_PATH = "/projects/synsight/data/chembl_35/chembl_35_sqlite/chembl_35.db"
    base_path = Path("<path_to_folder_to_store_the_extracted_data>")
